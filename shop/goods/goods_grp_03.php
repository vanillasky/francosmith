...
try {
	...
	if (!$cfg_step[2]['sort_type'] || $cfg_step[2]['sort_type'] == '1') {
		...
		list($add_table, $add_where, $add_order) = $mainAutoSort->getSortTerms($cfg_step[2]['categoods'], $cfg_step[2]['price'], $cfg_step[2]['stock_type'], $cfg_step[2]['stock_amount'], $cfg_step[2]['regdt'], $sortNum);
