<?php /* Template_ 2.2.7 2016/04/30 08:52:17 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/order/settle.htm 000014212 */ 
...
<div class="page-wrapper">
	...
	<div class="page_title_div">
		<div class="page_title">Review Order</div>
		<div class="page_path"><a href="/shop/">HOME</a> &gt; <span class='bold'>Review Order</span></div>
	</div>
	...
	<div class="indiv"><!-- Start indiv -->
		...
		<form name=frmSettle method=post action="<?php echo $TPL_VAR["orderActionUrl"]?>" target="ifrmHidden" onsubmit="returnf false;" >
...
<?php }}?>
		...
		<div style="text-align:left"><img src="/shop/data/skin/freemart/img/common/payment_txt_01.gif" border=0></div>
		
		<!-- 01 주문자정보 -->
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title"><img src="/shop/data/skin/freemart/img/common/order_step_01.gif"></td>
			<td id="orderbox">
		...
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title"><img src="/shop/data/skin/freemart/img/common/order_step_02.gif"></td>
			<td id="orderbox">
...
<?php if($TPL_VAR["road_address"]){?><div style="padding-top:5px;font:12px dotum;color:#999;"><?php echo $TPL_VAR["road_address"]?> <?php echo $TPL_VAR["address_sub"]?></div><?php }?>
		...
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title"><img src="/shop/data/skin/freemart/img/common/order_step_03.gif"></td>
			<td id="orderbox">
...
<?php }?>
		...
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title"><img src="/shop/data/skin/freemart/img/common/order_step_04.gif"></td>
			<td id="orderbox">
...
<?php }?>
		...
		<div style="padding:20px" align=center id="avoidDblPay">
			<button class="button-red button-big-wide" onclick="javascript:submitSettleForm(); return false;">결제하기</button>
			<button class="button-dark button-big-wide" onclick="location.href='<?php echo url("order/order.php")?>&';">이전으로</button>
		<!-- 	
		<a href="javascript:submitSettleForm()"><img src="/shop/data/skin/freemart/img/common/btn_payment.gif"></a>
		<a href="<?php echo url("order/order.php")?>&"><img src="/shop/data/skin/freemart/img/common/btn_back.gif"></a>
		-->
		</div>
...
function swapSettleButton(){
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "<a href='javascript:submitSettleForm()'><img src='/shop/data/skin/freemart/img/common/btn_payment.gif'></a><a href='<?php echo url("order/order.php")?>&'><img src='/shop/data/skin/freemart/img/common/btn_back.gif'></a>";
}
...
<?php }?>
	...
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "--- 현재 결제처리중입니다. 잠시만 기다려주세요. ---<br><a href='javascript:swapSettleButton();'><img src='/shop/data/skin/freemart/img/common/btn_cancel.gif'></a>";
