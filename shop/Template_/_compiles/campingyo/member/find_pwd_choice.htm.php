		...
		<div class="method-wrap">
			<div class="method" style="background-image:url(/shop/data/skin/campingyo/img/common/img_re_email.gif);">
				<div class="cont">
					...
					<a href="javascript:void(0);" onClick="<?php if($TPL_VAR["temp_email"]){?>selectOption(1);<?php }else{?>alert('이메일 주소가 올바르지 않아, 전송할 수 없습니다.');<?php }?>"><img src="/shop/data/skin/campingyo/img/common/btn_get_authnum.gif" align="absmiddle" /></a>
				</div>
			</div>
		</div>
<?php }?>
		...
		<div class="method-wrap">
			<div class="method" style="background-image:url(/shop/data/skin/campingyo/img/common/img_re_phone.gif);">
				<div class="cont">
					...
					<a href="javascript:void(0);" onClick="<?php if($TPL_VAR["temp_mobile"]){?>selectOption(2);<?php }else{?>alert('휴대폰 번호가 올바르지 않아, 전송할 수 없습니다.');<?php }?>"><img src="/shop/data/skin/campingyo/img/common/btn_get_authnum.gif" align="absmiddle" /></a>
				</div>
			</div>
		</div>
<?php }?>
