...
function GMultiOption(isSoldout) {
	...
	this.add = function() {
			...
			if (chkGoodsForm(form)) {
				...
				td = tr.insertCell(-1);
				html = '';
				html += '<div style="float:left; margin-right:3px; padding-top:10px;"><input type=text name=_multi_ea[] id="el-ea-'+key+'" size=2 value='+ _data.ea +' style="border:1px solid #D3D3D3;width:30px;text-align:right;height:20px;" onblur="nsGodo_MultiOption.ea(\'set\',\''+key+'\',this.value);"></div>';
