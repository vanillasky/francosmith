...
function chkFormList(mode){
	...
	if (inArray(mode, new Array('link','move')) && document.getElementsByName("sCate[]")[0].value == ''){
...
<form name="fmList" class="admin-form" method="post" onsubmit="return false" target="ifrmHidden" action="./indb_adm_goods_manage_link.php">
...
<tr>
	...
	선택한 상품을 <script type="text/javascript">new categoryBox('sCate[]',4,'<?=$sCategory?>','','fmList');</script> 으로
