...
<div class="title title_top">상품후기 게시판 공지<span></span></div>

<table class=tb>
<col class=cellC><col class=cellL>
<tr>
	<td>제목</td>
	<td><input type="text" name="subject" value="<?=$data['subject']?>" style="width:90%;" class=line required fld_esssential label="제목"></td>
</tr>
<tr>
	<td>내용</td>
	<td>
