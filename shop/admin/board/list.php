...
<div class="title title_top">게시판리스트<span>생성된 게시판을 수정하고 관리합니다 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=board&no=2')"><img src="../img/btn_q.gif" border=0 hspace=2 align=absmiddle></a></div>
...
<tr><td><img src="../img/icon_list.gif" align=absmiddle>글올리기, 질문의 답변, 게시글의 수정, 삭제 등은 [게시글 관리]에서 통합으로 관리하세요.<br /><img src="../img/btn_viewbbs.gif" align=absmiddle> 버튼을 눌러 사용자페이지의 게시판에서 직접 관리도 가능합니다.</td></tr>
