...
if($_GET['mode'] == 'register_mobile'){
	...
	$location = "쿠폰발행관리 > 모바일샵 전용 쿠폰만들기";
	$msg = "<div class='title title_top'>모바일샵 전용 쿠폰만들기<span>고객에게 발급할 쿠폰을 만듭니다.";
}else{
	$location = "쿠폰발행관리 > 모바일샵 전용 쿠폰발급내역관리";
	$msg = "<div class='title title_top'>모바일샵 전용 쿠폰수정하기<span>고객에게 발급할 쿠폰을 수정합니다.";
}
