...
O.price,
COUNT( DISTINCT WS.m_no ) AS `wish_cnt`
";
...
function fnDownloadStatistics() {
	if (confirm('검색된 통계 내역을 다운로드 하시겠습니까?')) {
		...
		f.method = 'post'; f.action = './indb.excel.popu.wishlist.php'; f.target = 'ifrmHidden';
		f.submit();
		f.action = ''; f.target = ''; f.method = '';
	}
}
</script>
<div class="title title_top">상품보관함 분석 <span>쇼핑몰 상품보관함에 담긴 상품별 순위 확인 및 분석 할 수 있습니다.</span><a href="javascript:manual('<?=$guideUrl?>board/view.php?id=data&no=33')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<tr height=25>
	...
	<td align=center><font class=ver81 color=444444><a href="javascript:popup('popu.wishlist.detail.php?goodsno=<?=$row[goodsno]?>&<?=$getString?>',850,600)"><?=number_format($row[wish_cnt])?></a></td>
...
<tr>
	...
	<td width="20%" align="right"><a href="javascript:void(0);" onClick="fnDownloadStatistics()"><a href="javascript:void(0);" onClick="fnDownloadStatistics()"><img src="../img/btn_download_s.gif"></a></a></td>
</tr>
</table>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">고객의 상품보관함에 담신 상품 분석을 통하여 고객의 구매성향 파악할 수 있으며, 판매 마케팅을 위한 이벤트 기획시에 효과적으로 활용할 수 있습니다.</td></tr>
