...
function fnDisplayChart(type) {

	['day','hour','yoil'].each(function(t){
		if (t == type)
			$('chart-tab-button-'+t).src = '../img/teb_'+t+'.gif';
		else
			$('chart-tab-button-'+t).src = '../img/teb_'+t+'_off.gif';
	});
	...
	var ajax = new Ajax.Request( "./indb.statistics.sales.day.chart.data.php",
	{
		method: "post",
		parameters: param,
...
function fnDetailStatistic(d) {
	...
	popupLayer('./statistics.sales.day.detail.php'+param,750,450);

}
</script>

<div class="title title_top">일별 매출통계 <span>일별 매출통계를 조회/분석 할 수 있습니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=data&no=24')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<tr>
	<td><a href="javascript:void(0);" onClick="fnDisplayChart('day');"><img src="../img/teb_day.gif" id="chart-tab-button-day"></a><a href="javascript:void(0);" onClick="fnDisplayChart('hour');"><img src="../img/teb_hour_off.gif" id="chart-tab-button-hour"></a><a href="javascript:void(0);" onClick="fnDisplayChart('yoil');"><img src="../img/teb_yoil_off.gif" id="chart-tab-button-yoil"></a></td>
...
<form name="frmExcelQuery" id="frmExcelQuery" method="post" action="indb.excel.statistics.sales.day.php" target="ifrmHidden">
