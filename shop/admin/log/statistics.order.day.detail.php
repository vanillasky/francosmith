...
// sql
	...
	SELECT
		...
		DATE_FORMAT(O.$dtkind,'%H') AS `date`,
...
$db->free($rs);
?>
<div class="title title_top">시간대별 주문통계</div>
...
<tr height=25>
	...
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_0'])?></td>
	<td class="numeric ar"><?=number_format($row['cnt_step_1'])?></td>
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_1'])?></td>
	<td class="numeric ar"><?=number_format($row['cnt_step_2'])?></td>
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_2'])?></td>
	<td class="numeric ar"><?=number_format($row['cnt_step_3'])?></td>
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_3'])?></td>
	<td class="numeric ar"><?=number_format($row['cnt_step_4'])?></td>
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_4'])?></td>
	<td class="numeric ar"><?=number_format($row['cnt_step_cancel'])?></td>
	<td class="cell1 numeric highlight  ar"><?=number_format($row['amount_step_cancel'])?></td>
</tr>
