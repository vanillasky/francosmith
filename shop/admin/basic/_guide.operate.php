...
<tr>
	<td><textarea name="guideOperate"><?php include $guideFilePath . 'guideOperate.txt'; ?></textarea></td>
</tr>
</table>
...
<div style="padding:5px 0 30px 5px;">
	<span class="small" style="line-height: 150%;"> 
		...
		- <span class="guideFontWeightBold">등록한 내용은 [이용안내 페이지]</span>에 표시됩니다.
	</span>
</div>
...
<tr>
	<td>
		<strong>· 이용안내 내용</strong><br />
		<span class="guidePaddingLeft">- 이용안내에 입력된 샘플 내용을 참고하여 실제 쇼핑몰 운영에 적합한 내용으로 수정하여 등록합니다.</span><br />
		<span class="guidePaddingLeft">- 이용안내 페이지에 나오며, 쇼핑몰 이용에 필요한 안내사항을 입력합니다.</span>
	</td>
</tr>
</table>
</div>