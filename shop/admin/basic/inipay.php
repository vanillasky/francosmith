...
<div id="MSG01">
	...
	<tr>
		...
		아직 이니시스와 계약을 하지 않으셨다면 ①<u>온라인신청 하신후</u> ②<u>계약서류를 우편으로 이니시스에 보내</u>주세요 <a href="../basic/pg.intro.php" target="_blank"><font color="#ffffff">[<u>계약 상세안내</u>]</font></a>
		</td>
	</tr>
	</table>
</div>
...
<tr>
	...
	<td class="noline">
	<? 
	$methodList = array('c'=>'신용카드', 'o'=>'계좌이체', 'v'=>'가상계좌', 'h'=>'휴대폰 결제','y'=>'옐로페이');
	...
	<?if($pgStatus == 'menual'){?>&nbsp;&nbsp;&nbsp;<span class="extext"><b>(반드시 이니시스와 계약한 결제수단만 체크하세요)</b></span><?}?>
		<div class="extext">
			*서비스 신청 간소화를 위해 옐로페이 결제수단 사용 설정 시 KG이니시스로의 지불수단 추가신청서 접수와 동일한 효력이 발생하며, 
...
<?php for ($i=1; $i<=3; $i++){ ?>
<tr>
	<td class="ver8"><b>이니시스 <font color="#627dce">Key <?php echo $i;?></b></b><br/> (Key File #<?=$i?>)</font></td>
