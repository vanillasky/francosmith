...
<tr>
	<td><textarea name="termsPolicyCollection1"><?php include $termsFilePath . 'termsPolicyCollection1.txt'; ?></textarea></td>
</tr>
</table>
...
<div style="padding:5px 0 30px 5px;">
	<span class="small" style="line-height: 150%;"> 
		...
		- <span class="termsFontWeightBold">등록한 내용은 [개인정보취급방침 페이지]</span>에 표시됩니다.
	</span>
</div>
...
<tr>
	<td class="pdv10">
		<strong>· 개인정보 취급방침 전체 내용(개인정보 취급방침 페이지)</strong><br />
		<span class="termsPaddingLeft">- 회원의 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지 전체 내용을 기재하는 영역입니다.</span><br />
		<span class="termsPaddingLeft">- 개인정보취급방침 페이지에 표시됩니다.</span>
