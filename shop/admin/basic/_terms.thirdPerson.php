...
<tr>
	...
	<td class="termsTableBorder termsBorderBottomZero termsPadding">
		<input type="radio" name="private2YN" value="Y" style="border:0px;" <?=$checked['private2YN']['Y']?>  /> 사용함&nbsp;&nbsp;
		<input type="radio" name="private2YN" value="N" style="border:0px;" <?=$checked['private2YN']['N']?>  /> 사용안함
	</td>
</tr>
<tr>
...
<div style="padding:5px 0 30px 5px;">
	<span class="small" style="line-height: 150%;"> 
		...
		- <span class="termsFontWeightBold">등록한 내용은 [회원가입 > 개인정보 제3자 제공 항목]</span>에 표시됩니다.
	</span>
</div>
...
<tr>
	<td>
		<strong>· 개인정보 제3자 제공 내용</strong><br />
		<span class="termsPaddingLeft">- 개인정보를 제3자에게 제공 하지 않는 경우 “사용안함”으로 체크를 하시면 됩니다.</span><br />
		<span class="termsPaddingLeft">- 개인정보 제3자 제공에 입력된 샘플 내용을 참고하여 실제 쇼핑몰 운영에 적합한 내용으로 수정하여 등록합니다.</span><br />
		<span class="termsPaddingLeft">- 개인정보 수집·이용에 대한 동의와는 별도로 '개인정보취급방침 내용'에서 개인정보를 제공받는 자,개인정보를 제공받는 자의 개인정보 이용목적,</span><br />
		<span class="termsPaddingLeft"> 제공하는 개인정보의 항목,개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 고지하고 동의를 받아야 합니다.</span><br />
		<span class="termsPaddingLeft">- 회원가입 페이지에 나오며, 이용자가 동의를 하지 않아도 가입을 할 수 있습니다. 단, 동의를 하지 않는 경우 이와 관련된 서비스의 이용이 불가능 하다는 내용이 명시되어야 합니다. </span>
	</td>
</tr>
</table>
</div>