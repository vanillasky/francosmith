<!-- 개인정보 수집 및 이용동의 내용(회원가입) -->
<table cellpadding="0" cellspacing="0" width="1000" border="0">
<tr>
	<td><textarea name="termsPolicyCollection2"><?php include $termsFilePath . 'termsPolicyCollection2.txt'; ?></textarea></td>
</tr>
</table>
...
<tr>
	<td class="pdv10">
		<strong>· 개인정보 수집 및 이용동의 내용(회원가입)</strong><br />
		<span class="termsPaddingLeft">- '개인정보취급방침 전체 내용＇에서 개인정보의 수집·이용목적,수집하는 개인정보의 항목,개인정보의 보유 및 이용 기간만 입력을 합니다.</span><br />
		<span class="termsPaddingLeft">- 회원가입 페이지에 표시되며, 이용자가 동의를 하지 않는 경우 회원가입이 되지 않습니다.</span><br />
