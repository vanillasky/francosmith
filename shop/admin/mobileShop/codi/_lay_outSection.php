...
<form method="post" name="fm" action="../mobileShop/codi/indb.php?mode=save&design_file=<?=$_GET['design_file']?>" onsubmit="return chkForm2( this );" enctype="multipart/form-data">
