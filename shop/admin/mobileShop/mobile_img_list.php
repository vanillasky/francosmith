...
<div class="title title_top">모바일샵 상품이미지 설정 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=mobileshop&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
