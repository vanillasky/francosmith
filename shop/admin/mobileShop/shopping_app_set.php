...
if ($category){
	$arWhere[] = sprintf("category like '%s%%'", $category);
}
...
<div class="title title_top">쇼핑몰 어플 설정 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=mobileshop&no=9')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<div class="title title_top">쇼핑몰 어플 상품 관리 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=mobileshop&no=9')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<div class="title title_top">쇼핑몰 어플 상품 진열 <font class=extext> 선택한 상품의 진열 상태를 변경합니다.</font> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=mobileshop&no=9')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
