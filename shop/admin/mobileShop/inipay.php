...
<div class="title title_top">
	이니시스 모바일결제 설정<span>전자결제(PG)사 신청서에 모바일 결제수단 이용을 체크하여 구매자에게 신용카드 등의 모바일 결제수단을 제공할 수 있습니다.</span>
</div>
...
<tr>
	...
	<td class="noline">
		...
		<input type="radio" name="pg[zerofee]" value="yes" <?php echo $checked['zerofee']['yes'];?> disabled="disabled" /> 무이자결제
...
<tr>
	...
	<td class="noline">
		...
		<input type="radio" name="pg[receipt]" value="Y" <?php echo $checked['receipt']['Y']?> /> 사용(먼저 이니시스에 현금영수증 사용을 신청한 후 선택하세요)
		</div>
