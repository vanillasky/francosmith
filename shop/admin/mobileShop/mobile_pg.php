...
<tr>
	<td>이용중인 PG사</td>
	<td style="padding-top:8px"><b><?if($nowPg){?><?=$nowPg?><?}else{?><font class=extext>쇼핑몰기본관리 &gt; 통합전자결제설정에서 전자결제정보를 설정해주세요.</font> <a href="../basic/pg.php"><font class=extext_l>[통합전자결제설정]</font></a><?}?>
	</b></td>
</tr>
</table>
