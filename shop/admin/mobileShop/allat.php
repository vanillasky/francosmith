...
if($cfg['settlePg']!="allat") $pg_mobile = array(); //pg타입체크
...
function get_pginfo(pgid){
	...
	{
		method: "post",
		parameters: "mode=getPginfo&pgtype=allat&mobilepg=y&pgid="+pgid,
		onComplete: function ()
		{
...
<div class="small_ex small_ex_padding" style="font-weight: bold; color: #0174DF;">올앳 관리자에 입력할 주소 : http://쇼핑몰도메인/shop/order/card/allat/allat_notiurl.php</div>
<div class="small_ex">③ 설정을 마치고 쇼핑몰 관리자 주문 페이지에서 자동 입금확인을 테스트해 보시기 바랍니다.</div>
<div class="small_ex small_ex_padding" style="font-weight: bold; color: #0174DF;">모바일샵용 PG ID 추가사용 시 입력할 주소 :  http://쇼핑몰도메인/shop/order/card/allat/mobile/allat_mobile_notiurl.php</div>
<div class="small_ex">④ 설정을 마치고 쇼핑몰 관리자 주문 페이지에서 자동 입금확인을 테스트해 보시기 바랍니다.</div>
