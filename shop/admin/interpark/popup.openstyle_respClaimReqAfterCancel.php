...
function respClaimReq(fObj)
{
	...
	if (clm_tpnm == '반품' && fObj['isaccept'][0].checked === true) mode = 'openstyle_rtnReqAcceptForComm';
	else if (clm_tpnm == '교환' && fObj['isaccept'][0].checked === true) mode = 'openstyle_exchReqAcceptForComm';
	else if (clm_tpnm == '반품' && fObj['isaccept'][0].checked === false) mode = 'openstyle_rtnReqRefuseForComm';
	else if (clm_tpnm == '교환' && fObj['isaccept'][0].checked === false) mode = 'openstyle_exchReqRefuseForComm';
