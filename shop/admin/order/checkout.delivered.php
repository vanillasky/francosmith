...
// 검색절 만듦
	...
	#1. 주문상태
		$arWhere[] = '('.$checkout_message_schema['extra_productOrderStatusType']['배송완료'].')';
...
<div class="title title_top">배송완료리스트 <span>배송완료된 주문건들을 확인/관리 하는 페이지 입니다.</span></div>
...
<form name="frmNaverCheckout" method="post" target="processLayerForm">
	...
	?>
		<tr height="25" bgcolor="#ffffff" bg="#ffffff" align="center">
			...
			<td><span class="ver81" style="color:#616161"><?=substr($row[DeliveredDate],0,-3)?></font></td>
			<td align="left">
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>구매자의 수취가 확인되어 배송완료된 주문내역을 확인, 관리합니다.</td></tr>
<tr><td>&nbsp;</td></tr>
