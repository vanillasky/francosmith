<?
$location = "주문관리 > 단계별 주문관리 > 배송중 리스트";
include "../_header.php";
...
<div class="title title_top" style="position:relative;padding-bottom:15px">배송중 리스트 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=order&no=28')"><img src="../img/btn_q.gif" border="0" hspace="2" align="absmiddle"/></a></div>
<?
...
<form name="frmSearch" id="frmSearch" method="get" action="">
	...
	<tr>
		...
		<select name="sort" onchange="this.form.submit();">
			...
			<option value="o.dlv_date desc" <?=$_GET['sort'] == 'o.dlv_date desc' ? 'selected' : '' ?>>배송일순↑</option>
			<option value="o.dlv_date asc" <?=$_GET['sort'] == 'o.dlv_date asc' ? 'selected' : '' ?>>배송일순↓</option>
		</select>&nbsp;
...
<form name="frmList" method="post" action="indb.php" id="frmList">
	...
	<col width="25"><col width="35"><col width="100"><col width="100"><col width="160"><col><col width="50"><col width="90"><col width="60"><col width="130"><col width="80">
	...
	?>
		<tr height=25 bgcolor="<?=$bgcolor?>" bg="<?=$bgcolor?>" align=center>
			...
			<td><font class=ver81 color=616161><?=substr($data[dlv_date],0,-3)?></font></td>
			<td align=left>
			...
			<td><span class="small1" style="color:#444444;"><?=$data['rcv_name']?></span></td>
			<td class=small4><?=$data['rcv_address']?> <?=$data['rcv_mobile']?></td>
			<td class=ver81>
				<a href="javascript:void(0);" onClick="fnDeliveryTrace('<?=$data['channel']?>','<?=$data['dlv_company']?>','<?=$data['dlv_no']?>');"><img src="../img/btn_int_order_tracking.gif"></a> <br>
				<?=$integrate_cfg['dlv_company'][$data['channel']][$data['dlv_company']]?> / <?=$data['dlv_no']?>
			</td>
		</tr>
	...
	<div>
		...
		<a href="javascript:void(0);" onClick="fnSetOrder(4);"><img src="../img/btn_int_order_complete.gif" align="absmiddle"></a>
		<a href="javascript:void(0);" onClick="fnSetOrder(2);"><img src="../img/btn_int_order_deliveryready.gif" align="absmiddle"></a>
	</div>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송중 상태의 주문건에 대한 리스트입니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>검색매뉴 조건에 맞게 배송중 상태의 주문서를 조회할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송추적 : 배송중인 택배의 배송상태를 확인할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송완료 처리</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;- 배송중인 주문건들을 확인하고 각 택배사 배송추적조회에서 배송완료된 주문건들을 선택하여 배송완료로 주문상태를 변경 합니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송준비중으로 변경</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;- 배송중인 주문건중 잘못처리된 주문건을 선택하여 다시 배송준비중으로 주문상태를 변경할 수 있습니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;※ 내이버체크아웃, 쇼플  옥션iPay  주문건은 입금확인으로 주문상태 변경이 불가능합니다.</td></tr>
</table>
</div>
