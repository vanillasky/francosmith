...
<tr>
	<td>상품가격</td>
	<td colspan="3" style="padding:5px;" class="noline">
	발행액 : <input type="text" name="amount" value="<?=$indata['amount']?>" style="text-align: right" size="8" readonly> 원<br>
	공급액 : <input type="text" name="supply" value="<?=$indata['supply']?>" style="text-align: right" size="8" readonly> 원
	( 과세액 : <input type="text" name="tax" value="<?=$indata['tax']?>" style="text-align: right" size="6" readonly> 원
	+ 면세액 : <input type="text" name="taxfree" value="<?=$indata['taxfree']?>" style="text-align: right" size="6" readonly> 원 )<br>
	부가세 : <input type="text" name="surtax" value="<?=$indata['surtax']?>" style="text-align: right" size="8" readonly> 원
	</td>
</tr>
<tr>
	<td>발행용도</td>
