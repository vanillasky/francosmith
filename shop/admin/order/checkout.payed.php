...
// 검색절 만듦
	...
	#1. 주문상태
		$arWhere[] = '('.$checkout_message_schema['extra_productOrderStatusType']['입금확인'].')';
...
<div class="title title_top">입금확인리스트 <span>결제가 완료된 주문내역을 확인/관리하는 페이지 입니다.</span></div>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>결제가 완료된 주문내역을 확인하고, 해당 주문건의 배송준비 여부를 처리합니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>발주확인 : 상품이 확보되어 배송이 가능한 주문건을 배송준비 처리합니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>발송지연 : 상품확보가 필요한 주문건을 배송보류 처리합니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/><span style="color:#93A0A6">발송지연 : </span>(발송지연 처리된 주문내역을 '배송준비중 리스트' 에서 발송지연 처리시 설정한 '발송기한'으로 확인 할 수 있습니다. )</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>판매취소 : 상품확보가 불가능한 주문건을 취소 처리합니다.</td></tr>
</table>
</div>
