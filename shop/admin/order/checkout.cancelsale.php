...
$arWhere=array();
$arWhere[] = "ORDER_OrderStatusCode = 'OD0002'";
...
<div class="title title_top">판매취소처리 <span>결제가 완료된 주문에 대해서 판매를 취소하기 위한 단계입니다</span></div>
...
<form id="chkFrm" action="checkout.api.CancelSale.php" target="processLayerForm" method="post">
<br><br>
...
<tr>
	<td></td>
	<td> <input type="button" value=" 선택한 주문 판매취소하기 " onclick="apiCall()"></td>
</tr>
</table>
</div>
</form>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>구매에 대한 입금이 완료된 주문입니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>품절 등으로 인해 판매가 불가능한 경우에는 ‘판매취소’를 눌러 주문을 취소해 주세요.</td></tr>
</table>
</div>
