<?
$location = "주문관리 > 주문취소 관리 > 반품/교환 리스트";
include "../_header.php";
...
// 검색절 만듦
	...
	#2. 주문 상태
		if ($_GET['ord_status'] == 'x0') {
			$arWhere[] = "(o.ord_status IN (30,40) OR (oi.cs = 'y' AND o.ord_status BETWEEN 2 AND 4))";
		}
		elseif ($_GET['ord_status'] == 'x1') {
			$arWhere[] = "(o.ord_status IN (31,41) OR (oi.cs = 'f' AND o.ord_status BETWEEN 2 AND 4))";
		}
		else {
			$arWhere[] = "(o.ord_status IN (30,31,40,41) OR (oi.cs <> 'n' AND o.ord_status BETWEEN 2 AND 4))";
		}
...
<div class="title title_top" style="position:relative;padding-bottom:15px">반품/교환 리스트 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=order&no=31')"><img src="../img/btn_q.gif" border=0 hspace=2 align=absmiddle></a></div>
...
<form name="frmSearch" id="frmSearch" method="get" action="">
	...
	<tr>
		...
		<td colspan="3">
			...
			<select name="dtkind">
				...
				<option value="cs_regdt"			<?=($_GET['dtkind'] == 'cs_regdt' ? 'selected' : '')?>			>반품/교환요청일</option>
	...
	<tr>
		...
		<a href="?<?=$_paging_query?>&ord_status=x0"><img src="../img/btn_int_order_list_claim_req<?=($_GET['ord_status'] == 'x0') ? '_on' : ''?>.gif"></a>
		<a href="?<?=$_paging_query?>&ord_status=x1"><img src="../img/btn_int_order_list_claim_fin<?=($_GET['ord_status'] == 'x1') ? '_on' : ''?>.gif"></a>
		</td>
...
<input type="hidden" name="ord_status" value=""><!-- 변경코자하는 상태값 -->
	...
	while ($data=$db->fetch($res,1)){
		...
		// 강조색, 선택 버튼 비활성화
		if (
			($data['ord_status'] == 31 || $data['ord_status'] == 41)
			||
			($data['cs']=='f' && ($data['ord_status'] >= 2 && $data['ord_status'] <= 4))
			||
			($data['channel'] != 'enamoo' && $data['ord_status'] == '40')
			)
		{
			$disabled = 'disabled';
			$bgcolor = '#F0F4FF';
	...
	?>
		<tr height=25 bgcolor="<?=$bgcolor?>" bg="<?=$bgcolor?>" align=center>
			<td class="noline"><input type="checkbox" name="chk[<?=$data['channel']?>][]" value="<?=$data['ordno']?>" class="chk_ordno" onclick="iciSelect(this)" <?=$disabled?><?php if($data['pg']==='ipay') echo ' data-ipay-pg="true"'; if($data['naver_mileage_save']=='1') echo ' data-naver-mileage="true"'; ?>/></td>
			...
			<?php if($data['naver_mileage_save']=='1') echo '<img style="vertical-align: middle;" src="/shop/admin/img/naver_mileage.jpg"/>'; ?>
			</td>
			<td align=left>
			<div>
	...
	<div class="button">
	<a href="javascript:void(0);" onClick="indbReturn();"><img src="../img/btn_returngood.gif"/></a>
	<a href="javascript:void(0);" onClick="indbExchange()"><img src="../img/btn_exchangegood.gif"/></a>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">반품/교환접수 및 완료 처리된 주문건에 대한 리스트입니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">검색매뉴 조건에 맞게 반품/교환접수, 완료 상태의 주문서를 조회할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">전체보기 : 조회된 주문 반품/교환 관련 리스트 전체를 확인할 수 있습니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">반품/교환접수 보기 : 조회된 반품/교환 리스트중 반품/교환 접수건만 확인할 수있습니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">반품/교환완료 보기 : 조회된 반품/교환 리스트중 반품/교환 완료건만 확인할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">반품완료 처리하기</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">&nbsp;&nbsp;- 반품주문이란 '배송중'이거나 '배송완료'인 상태에서 고객의 요청으로 주문취소가 된 주문을 말합니다.</td></tr>
...
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">교환완료 후 재주문넣기</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">&nbsp;&nbsp;- 교환은 맞교환만 가능합니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;맞교환이란 파손된 불량상품이거나 하자가 있는 상품의 경우 같은 상품으로의 교환처리를 말합니다.</td></tr>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이렇게 생성된 재주문은 주문리스트에서 [재주문]아이콘으로 표시되어 주문접수되며, 바로 입금확인 처리후 재배송을 진행하면 됩니다.</td></tr>
</table>
</div>
