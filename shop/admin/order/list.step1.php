<?
$location = "주문관리 > 단계별 주문관리 > 입금확인 리스트";
include "../_header.php";
...
// 검색절 만듦
	...
	#2. 주문 상태
		// 입금 확인리스트 이므로, 입금 확인 건으로 고정
		$arWhere[] = "(o.ord_status = 1)";
...
<div class="title title_top" style="position:relative;padding-bottom:15px">입금확인 리스트 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=order&no=26')"><img src="../img/btn_q.gif" border="0" hspace="2" align="absmiddle"/></a></div>
<?
...
<form name="frmList" method="post" action="indb.php" id="frmList">
	...
	<col width="25"><col width="35"><col width="100"><col width="100"><col width="160"><col><col width="50"><col width="90"><col width="60"><col width="50"><col width="60">
	...
	?>
		<tr height=25 bgcolor="<?=$bgcolor?>" bg="<?=$bgcolor?>" align=center>
			...
			<td><font class=ver81 color=616161><?=substr($data[pay_date],0,-3)?></font></td>
			<td align=left>
			...
			<td class=small4><?=settleIcon($data['pg']);?> <?=$integrate_cfg['pay_method'][$data['pay_method']]?></td>
	...
	?>
	<tr>
		<td><a href="javascript:chkBoxAll(document.getElementsByName('chk[]'),'rev')"><img src="../img/btn_allchoice.gif" border=0></a></td>
	...
	<div>
		...
		<a href="javascript:void(0);" onClick="fnSetOrder(2);"><img src="../img/btn_int_order_ready.gif" align="absmiddle"></a>
		<a href="javascript:void(0);" onClick="fnSetOrder(0);"><img src="../img/btn_int_order_accept.gif" align="absmiddle"></a>
	</div>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>입금완료/결제완료 상태의 주문건에 대한 리스트입니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>검색매뉴 조건에 맞게 입금완료 상태의 주문서를 조회할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송준비중 처리</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;- 입금확인이 된 주문건들의 내역을 확인하고 배송준비가 가능한 주문건을 선택하여 배송준비중으로 주문상태를 변경 합니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>입금대기로 변경</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;- 입금확인 처리된 무통장 결제 주문건을 선택하여 다시 입금대기로 주문상태를 변경하여 미입금 처리합니다. </td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;※네이버체크아웃, 쇼플, 옥션iPay  주문건은 입금대기로 주문상태 변경이 불가능합니다. </td></tr>
</table>
</div>
