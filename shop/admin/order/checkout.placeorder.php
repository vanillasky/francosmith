...
$arWhere=array();
$arWhere[] = "ORDER_OrderStatusCode in ('OD0002')";
...
<div class="title title_top">발주처리 <span>결제가 완료된 주문에 대해서 배송 시작을 위한 접수처리를 하는 단계입니다</span></div>
...
<form id="chkFrm" action="checkout.api.PlaceOrder.php" target="processLayerForm" method="post">
<br><br>
...
<input type="button" value=" 선택한 주문 접수처리하기 " onclick="apiCall()">
</form>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>구매에 대한 입금이 완료된 주문입니다. 주문내역을 확인하시고 판매가 가능한 주문은 선택 후 주문접수 버튼을 눌러주세요.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>입금 완료 주문에 대해서는 3영업일 이내에 발송 처리해 주세요. </td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>주문 접수를 진행하지 않고 발송이 진행된 건에 대한 주문 취소의 경우 해당 쇼핑몰에서 왕복 배송비를 부담해야 하니 주의해 주세요.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>주문확인 이후에는 구매자의 주문 취소가 불가능합니다.</td></tr>
</table>
</div>
