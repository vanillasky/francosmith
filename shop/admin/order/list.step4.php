<?
$location = "주문관리 > 단계별 주문관리 > 배송완료 리스트";
include "../_header.php";
...
<div class="title title_top" style="position:relative;padding-bottom:15px">배송완료 리스트 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=order&no=29')"><img src="../img/btn_q.gif" border="0" hspace="2" align="absmiddle"/></a></div>
<?
...
<form name="frmSearch" id="frmSearch" method="get" action="">
	...
	<tr>
		...
		<select name="sort" onchange="this.form.submit();">
			...
			<option value="o.fin_date desc" <?=$_GET['sort'] == 'o.fin_date desc' ? 'selected' : '' ?>>배송완료일순↑</option>
			<option value="o.fin_date asc" <?=$_GET['sort'] == 'o.fin_date asc' ? 'selected' : '' ?>>배송완료일순↓</option>
		</select>&nbsp;
...
<form name="frmList" method="post" action="indb.php" id="frmList">
	...
	<col width="25"><col width="35"><col width="100"><col width="100"><col width="160"><col><col width="50"><col width="90"><col width="60"><col width="80">
	...
	?>
		<tr height=25 bgcolor="<?=$bgcolor?>" bg="<?=$bgcolor?>" align=center>
			...
			<td><font class=ver81 color=616161><?=substr($data[fin_date],0,-3)?></font></td>
			<td align=left>
	...
	<div>
		...
		<a href="javascript:void(0);" onClick="fnSetOrder(3);"><img src="../img/btn_int_order_delivery2.gif" align="absmiddle"></a>
	</div>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송완료 상태의 주문건에 대한 리스트입니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>검색매뉴 조건에 맞게 배송완료 상태의 주문서를 조회할 수 있습니다.</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>배송중으로 변경</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;- 배송완료된 주문건중 잘못 처리하였거나, 배송완료가 되지 않은 주문건을 선택하여 다시 배송중으로 주문상태를 변경합니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"/>&nbsp;&nbsp;※ 네이버체크아웃, 쇼플, 옥션iPay 주문건은 배송중으로 주문상태 변경이 불가능합니다.</td></tr>
</table>
</div>
