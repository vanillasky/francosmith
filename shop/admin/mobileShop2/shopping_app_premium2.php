...
$location = "모바일샵관리 > 쇼핑몰 어플 자유주제탭 설정 2";
include "../_header.php";
...
$data_apppremium = unserialize($load_config_shoppingApp['app_premium2']);
...
<div class="title title_top">쇼핑몰 어플 자유주제탭 설정 2 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=mobileshopV2&no=10')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
<form name="f_app_list" method="post" action="indb.php" enctype="multipart/form-data" onsubmit="return chkForm(this);">
<input type="hidden" name="mode" value="AppPremium2">
...
<div>
	...
	<col class=cellC><col class=cellL>
		...
		<tr class="noline">	
			...
			<? if($v['thumbnail'] && file_exists("../../data/m/app2/".$v['thumbnail']) ){
					echo "<img src='../../data/m/app2/".$v['thumbnail']."' width='50px' height='50px'>";
