...
<div id="codi_map" class="codi_map">
	<div id="frame_main">
		...
		<div id="frame_outHeader">
			<div class="ver81">outline/_header.htm <a href="../mobileShop2/iframe.codi.php?design_file=outline/_header.htm"><img src="../img/btn_html.gif" /></a></div>
		</div>
		...
		<div id="frame_header">
			<div class="ready">
				...
				<a href="../mobileShop2/iframe.codi.php?design_file=outline/_header.htm"><img src="../img/btn_html.gif"></a>
				</div>
			</div>
		</div>
		<!-- 1. 상단디자인 : End -->
		...
		<!-- 2. 본문디자인 : Start -->
		<div id="frame_body"><div class="ready"><div><img src="../img/codi_main_03_on.gif"> <A HREF="../mobileShop2/iframe.codi.php?design_file=index.htm"><img src="../img/btn_html.gif" /></A></div></div></div>
		<!-- 2. 본문디자인 : End -->
		...
		<div id="frame_footer">
			<div class="ready">
				...
				<a href="../mobileShop2/iframe.codi.php?design_file=outline/_footer.htm"><img src="../img/btn_html.gif"></a>
				</div>
			</div>
		</div>
		<!-- 3. 하단디자인 : End -->
		...
		<div id="frame_outFooter">
			<div class="ver81">outline/_footer.htm <a href="../mobileShop2/iframe.codi.php?design_file=outline/_footer.htm"><img src="../img/btn_html.gif" /></a></div>
		</div>
