...
<form method="post" name="fm" action="../mobileShop2/codi/indb.php?mode=save&design_file=<?=$_GET['design_file']?>" onsubmit="return chkForm2( this );" enctype="multipart/form-data">
...
<tr>
	...
	<td>
		...
		<a href="javascript:webftpinfo( '<?=( $data_file['inbg_img'] != '' ? '/data/skin/' . $cfg['tplSkinWork'] . '/img/codi/' . $data_file['inbg_img'] : '' )?>' );"><img src="../img/codi/icon_imgview.gif" border="0" alt="이미지 보기" align="absmiddle"></a>
		<? if ( $data_file['inbg_img'] != '' ){ ?>&nbsp;&nbsp;<span class="noline"><input type="checkbox" name="inbg_img_del" value="Y">삭제</span><? } ?>
	</td>
</tr>
<? } ?>
</table>
