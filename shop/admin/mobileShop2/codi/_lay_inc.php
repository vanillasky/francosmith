...
<form method="post" name="fm" action="../mobileShop2/codi/indb.php?mode=save&design_file=<?=$_GET['design_file']?>" onsubmit="return chkForm( this );" enctype="multipart/form-data">
<input type="hidden" name="linkurl" value="<?=$data_file['linkurl']?>">


<div style="border-top:1px solid #DDDDDD; margin:17px 0;">
<table class=tb>
