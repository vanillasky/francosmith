...
$where = array();
$where[] = "SC.email <> ''";
if ($_GET['sword']) $where[] = " SC.email like '%".$_GET['sword']."%' ";
...
<input type=hidden name="sort" value="<?=$_GET['sort']?>">
	<div class="title title_top">이메일(정기구독) 발송 <span>정기구독 신청자들에게 메일을 발송합니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=todayshop&no=16')"><img src="../img/btn_q.gif" border=0 hspace=2 align=absmiddle></a></div>
	<table class=tb>
...
function sendAmail(fm)
{
	...
	fm.target = "ifrmEmail";
	fm.action = "../member/amail.php?ifrmScroll=1";
	fm.submit();
}
</script>

<div align="right"><a href="javascript:popup('../member/amail.php?charge=y',850,700);"><img src="../img/btn_point.gif"></a></div>
...
<tr>
	...
	<a href="javascript:void(0)" onClick="sendAmail(document.fmList)"><img src="../img/btn_today_email_w.gif"></a>
	</td>
</tr>
</table>
</div><p>
...
<tr>
	<td align="center">
	<iframe name="ifrmEmail" style="width:880px;height:900px" frameborder=0></iframe>
	</td>
</tr>
</table>
