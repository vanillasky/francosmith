...
<tr>
	...
	<div style="float:left;padding:0 0 0 5" id="btPgId"><!--button type="button" onclick="if(chkPgid()){alert('o')}else{alert('x')}">아뒤테슷</button--><!--a href="javascript:openPrefix();"><img src="../img/pginfo.gif" alt="개별 승인 신청" /></a--></div>
	<div style="clear:both" class="extext">LG U+ ID는 'go,fp,fd,gs’로 시작되는 아이디만 입력 가능합니다. (단, 기존 입력값은 무방합니다)</div>
	<div class="extext">고도몰에서 신청하지 않은, 다른 값으로 시작되는 아이디의 경우에는 개별 승인신청을 하셔야 합니다.</div>
	</td>
</tr>
<tr>
