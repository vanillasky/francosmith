...
<div id="codi_map" class="codi_map">
	<div id="frame_main">
		...
		<div id="frame_outHeader">
			<div class="ver81">outline/_header.htm <a href="../design/codi.php?design_file=outline/_header.htm" target="_blank"><img src="../img/btn_html.gif" /></a></div>
		</div>
		...
		<div id="frame_header">
			<div class="ready">
				...
				<select name="outline_header" id="outline_header" onchange="DCMAPM.file_outline( this.name )" class="ver81" style="padding:0">
				<? foreach( $layout['header'] as $opt ){ echo '<option value="' . $opt['value'] . '" ' . $opt['selected'] . ' path="' .$opt['path'] . '">' .$opt['text'] . '</option>'; } ?>
				</select>
				<a href="javascript:designcodeMove( fm.outline_header );"><img src="../img/btn_html.gif"></a>
				</div>
			</div>
		</div>
		<!-- 1. 상단디자인 : End -->
		...
		<!-- 2. 측면디자인 : Start -->
		<input type="hidden" name="outline_side" value="noprint" />
		<!--
		<div id="frame_side">
			<div class="ready">
				<div>
		...
		<!-- 3. 본문디자인 : Start -->
		<div id="frame_body"><div class="ready"><div><img src="../img/codi_main_03_on.gif"> <A HREF="../todayshop/iframe.codi.php?design_file=todayshop/today_goods.htm"><img src="../img/btn_html.gif" /></A></div></div></div>
		<!-- 3. 본문디자인 : End -->
		...
		<div id="frame_footer">
			<div class="ready">
				...
				<select name="outline_footer" id="outline_footer" onchange="DCMAPM.file_outline( this.name )" class="ver81" style="padding:0">
				<? foreach( $layout['footer'] as $opt ){ echo '<option value="' . $opt['value'] . '" ' . $opt['selected'] . ' path="' .$opt['path'] . '">' .$opt['text'] . '</option>'; } ?>
				</select>
				<a href="javascript:designcodeMove( fm.outline_footer );"><img src="../img/btn_html.gif"></a>
				</div>
			</div>
		</div>
		<!-- 4. 하단디자인 : End -->
		...
		<div id="frame_outFooter">
			<div class="ver81">outline/_footer.htm <a href="../design/codi.php?design_file=outline/_footer.htm" target="_blank"><img src="../img/btn_html.gif" /></a></div>
		</div>
	...
	<div id="frame_scroll">
		...
		<p><a href="../todayshop/iframe.codi.php?design_file=outline/_footer.htm"> <img src="../img/btn_html.gif"></a></p>
		<p><a href="../todayshop/iframe.codi.php?design_file=proc/scroll.js"> <img src="../img/btn_script.gif"></a></p>
		</div>
	</div>
	-->
	<!-- 5. 스크롤 : End -->
