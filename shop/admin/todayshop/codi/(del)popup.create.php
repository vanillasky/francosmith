...
<center style="margin:5px 0px;" class="noline"><input type="image" src="../../img/btn_save_s.gif" alt="저장"> <a href="javascript:DCCM.call();"><img src="../../img/btn_cancel_s.gif" border=0></a></center>
</form>
