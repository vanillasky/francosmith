...
<form method="post" name="fm" action="../todayshop/codi/indb.php?mode=save&design_file=<?=$_GET['design_file']?>" onsubmit="return chkForm2( this );" enctype="multipart/form-data">
<input type="hidden" name="linkurl" value="<?=$data_file['linkurl']?>">


<?
if ($todayShop->cfg['shopMode'] == "todayshop") @include_once dirname(__FILE__) . "/_codi_map.php";
?>
