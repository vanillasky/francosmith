...
<div class="title title_top">투데이샵 메인팝업창 관리<span>투데이샵 메인 팝업창에 대한 설정을 추가 변경하실 수 있습니다</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=member&no=2')"><img src="../img/btn_q.gif" border="0" align="absmiddle" /></a></div>
<?=$workSkinTodayStr?>
<table class="tb">
