...
<tr>
	...
	<input type="radio" name="introUseYN" value="Y" <?=( $cfg['introUseYN'] == 'Y' ? 'checked' : '' )?> required label="사용여부" onClick="fnToggleIntroForm(true);" /> 사용
	<input type="radio" name="introUseYN" value="N" <?=( $cfg['introUseYN'] != 'Y' ? 'checked' : '' )?> required label="사용여부" onClick="fnToggleIntroForm(false);" /> 사용안함
	</td>
</tr>
</table>
...
<tr>
	<td><font class=extext>인트로/공사중페이지의 주소는 <font class=ver7 color="#627dce"><b>http://<font class=small1><b>도메인</b></font>/shop/intro.php</b></font> 입니다</td>
	<td width=10></td>
...
<tr>
	<td><font class=extext>쇼핑몰 메인페이지의 주소는 <font class=ver7 color="#627dce"><b>http://<font class=small1><b>도메인</b></font>/shop/main/index.php </b></font> 입니다</td>
	<td width=10></td>
...
<tr>
	<td class="noline">
		<label><input type="radio" name="custom_landingpage" value="1" <?=$cfg['custom_landingpage'] == 1 ? 'checked' : ''?> />페이지 방문의 제한이 없는 일반적인 인트로 페이지</label>
	</td>
	<td>전체</td>
...
<tr>
	<td class="noline">
		<label><input type="radio" name="custom_landingpage" value="2" <?=$cfg['custom_landingpage'] == 2 ? 'checked' : ''?> <?=!$adultro_ready ? 'disabled' : ''?> />성인 인증 용 인트로 페이지</label><br>
...
<tr>
	<td class="noline"><label><input type="radio" name="custom_landingpage" value="3" <?=$cfg['custom_landingpage'] == 3 ? 'checked' : ''?> />메인페이지 접속이 회원만 접근 가능한 인트로 페이지</label></td>
	<td>회원</td>
