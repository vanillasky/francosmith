...
<div class="title title_top">폰트 구경 신청<span></span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=design&no=15')"><img src="../img/btn_q.gif" border="0" align="absmiddle"></a></div>
