...
<div class="title title_top">새로운 페이지 추가하기<span>새롭게 필요한 페이지를 추가합니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=design&no=11')"><img src="../../img/btn_q.gif" border="0" align="absmiddle"></a></div>
