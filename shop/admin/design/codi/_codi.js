...
DCTM = {
	...
	write: function (t_name, t_width, t_rows, t_property, tplFile)
	{
		...
		\
		<div class="head">\
		<input type="button" class="icon" style="background:url(../img/btn_ae_webftp.gif);width:97px; no-repeat 0 bottom;" title="WebFTP 이미지 관리(ActiveX)" onclick="javascript:popup2(\'popup.webftp_activex.php\',760,610,0)">\
