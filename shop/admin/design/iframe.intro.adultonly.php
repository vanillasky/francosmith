...
<div class="title title_top">인트로(성인/회원) 페이지 디자인<span>성인/회원전용 인트로 페이지의 디자인을 수정합니다.</span></div>
...
<?=gen_design_history_tag('skin', $cfg['tplSkinWork'], 'main/intro_adult.htm'); ?>
...
{ // 디자인코디툴
	...
	$tmp['tplFile']		= "/main/intro_adult.htm";
