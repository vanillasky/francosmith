<?php
$location = "쇼핑몰 App관리 > 메인화면 템플릿 선택";
include "../_header.php";
...
?>
<div class="title title_top"><div id="select_title">쇼핑몰 App 메인화면 템플릿 선택 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=13')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div><div id="edit_title" style="display:none;">쇼핑몰 App 메인화면 템플릿 편집 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=13')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div> </div>
...
<div><iframe id=ifrmMyTemplate name=ifrmMyTemplate src="iframe.shopTouch_myTemplate.php?ifrmScroll=1&menu_idx=main" style="width:834px;height:185px;scroll-bar:none;" scrolling="no" frameborder=0></iframe></div>
...
<div><iframe id=ifrmTemplate name=ifrmTemplate src="iframe.shopTouch_template.php?ifrmScroll=1&menu_idx=main" style="width:834px;height:185px;scroll-bar:none;" scrolling="no" frameborder=0></iframe></div>
</div>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">쇼핑몰 App의 메인화면을 구성할 수 있습니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">아래 템플릿 선택에서 제공되는 템플릿을 선택후 편집하시어 저장하시면 나의 템플릿으로 이동됩니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">나의 템플릿에 편집해 놓은 템플릿을 적용하여 메인화면을 구성할 수 있습니다.</td></tr>
</table>
</div>
