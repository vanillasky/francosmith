...
$tmp_template = $pAPI->getTemplate($godo['sno'], $arr);
...
.template-use {border:dotted 2px #FF0000;}
</style>
...
<div class="template-box">
	...
	if(empty($arr_template)) { ?>
		<div class="template-info"><div style="position:absolute;top:50%;">사용 가능한 템플릿이 없습니다.</div></div>
		<? } else {
	...
	<div class="template" id="div_template_<?=$i?>">
		...
		<div class="template-btn">
			<div class="template-btn-left"><a href="javascript:editTemplate('<?=$row_template['tp_idx']?>');"><img src="../img/btn_s_edit.gif" alt="편집"></a> </div>
...
window.onload = function(){
	parent.document.getElementById('ifrmTemplate').style.height = document.body.scrollHeight;
}
