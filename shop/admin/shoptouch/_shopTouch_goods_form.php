...
function addfldShoptouch(obj)
{
	...
	if(tb.rows.length > 10) {
		alert("쇼핑몰 App용 이미지는 최대 10개까지 등록 가능합니다.");
		return;
	}
...
<? } ?>
<!-- 상품 카테고리 선택 -->
<div class="title title_top">상품분류정보<span>한상품에 여러개의 e나무 분류를 등록할 수 있습니다&nbsp;(다중분류기능지원)</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<!-- 상품기본정보 -->
<div class=title>상품기본정보<span>제조사, 원산지, 브랜드가 없는 경우 입력안해도 됩니다 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
<table class=tb>
...
<tr>
	<td>쇼핑몰 App 출력여부</td>
	<td class=noline>
		<input type=checkbox name=open_shoptouch value=1 <?=$checked['open_shoptouch'][1]?>>보이기
		<font class=extext>(체크해제시 쇼핑몰 App 화면에서 안보임)</font>
	</td>
</tr>
<tr>
	<td>유사검색어</td>
...
<!-- 상품추가정보 -->
<div class=title>상품추가정보<span>상품특성에 맞게 항목을 추가할 수 있습니다 (예. 감독, 저자, 출판사, 유통사, 상품영문명 등) <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></span>
...
<!-- 상품적립금 -->
<div class=title>적립금<span>이 상품 주문시 적립되는 적립금을 설정합니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
<div class=noline style="padding-bottom:5px">
...
<!-- 상품 가격/재고 -->
<div class=title>가격/재고/배송비<span>사이즈, 색상 등에 의해 가격이 여러개인 경우 가격옵션을 추가할 수 있습니다 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<tr>
	...
	최대구매수량 : <input type="text" name="max_ea" size=5 value="<?=$data['max_ea']?>">(0이면 제한이 없습니다)
	</td>
	...
	<div style="padding-top:3px"><font class=extext>(품절되면 상세페이지에 재입고 알림신청 버튼이 노출됩니다)</font></div></td>
	</td>
</tr>
<tr>
	<td>과세/비과세</td>
...
<tr>
	...
	<tr height=40>
		<td>
		<input type="radio" name="delivery_type" value="0" <?=$checked[delivery_type][0]?> class="null" onclick="chk_delivery_type();">기본배송정책에 따름&nbsp;<input type="radio" name="delivery_type" value="1" <?=$checked[delivery_type][1]?> class="null" onclick="chk_delivery_type();"> 무료배송
		&nbsp;<input type="radio" name="delivery_type" value="2" <?=$checked[delivery_type][2]?> class="null" onclick="chk_delivery_type();">상품별 배송비 입력
		...
		&nbsp;<input type="radio" name="delivery_type" value="3" <?=$checked[delivery_type][3]?> class="null" onclick="chk_delivery_type();">착불배송비
		<span style="display:none;" id="gdi2">&nbsp;<input type="text" name="goods_delivery2" value="<?=$data['goods_delivery']?>" size="8" onkeydown="onlynumber()">원</span></td>
	</tr>
	</table>
...
<tr>
	<td>
		<input type="radio" id="purchaseEachApply" name="purchaseApplyOption" style="border:0px;" value="2" onclick="document.getElementById('objOption').style.display = 'block';chkPurchaseOption(this.value);" /><label for="purchaseEachApply">사입처 개별 적용</label> <span class="extext">추가옵션이 동일한 사입처에서 입고 된 경우</span>
	</td>
</tr>
</table></div>
...
<!-- 추가옵션 -->
<div class=title>추가옵션/추가상품/사은품<span>추가옵션을 무제한 등록할 수 있으며, 추가상품을 판매하거나 사은품을 제공할 수도 있습니다 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
<div class=noline style="padding-bottom:5px">
...
<?
	...
	<div style="padding-top:10px"><span style="color:#627dce">※</span> <span class="extext">추가옵션/추가상품/사은품으로 지정한 상품은 쿠폰 및 회원할인이 적용되지 않습니다</span></div>
</div>
...
<!-- 관련상품 -->
<div class=title>관련상품<span>이상품과 관련있는 상품을 추천하세요 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/icon_sample.gif" border="0" align=absmiddle></a></div>
...
<!--  qr code 설정 -->
<? if($qrCfg['useGoods'] == "y"){ ?>
<div class=title>QR Code 노출<span>상품 상세보기에 QR Code 를 보여줍니다. <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/icon_sample.gif" border="0" align=absmiddle></a></div>
...
<? } ?>
<!-- 상품 디테일뷰 -->
<div class=title>상품이미지 돋보기 효과<span>상품상세이미지에 마우스를 오버하여 상품이미지를 확대하여 볼 수 있는 기능입니다. <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></span></div>
<div style="padding-bottom:5px" class=noline>
...
<!-- 상품 이미지 -->
<div class=title>쇼핑몰 App 상품 이미지<span>쇼핑몰 App 전용 상품이미지 입니다. 수정하시려면 반드시 삭제를 체크 하시고 파일을 다시 올려주세요.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/icon_sample.gif" border="0" align=absmiddle></a></div>
<!-- 기존 이나무 이미지는 수정하지 않기 위함 -->
...
<tr>
	...
	<tr>
		...
		<td>
		<? if ($v[$i]){ ?>
		<div style="padding:0 0" class=noline><input type=checkbox name=del[img_<?=$k?>][<?=$i?>]><font class=small color=#585858>삭제</font></div>
...
<div class="noline" style="padding:5px 0 0 5px;border-bottom:3px solid #999;">
	...
	<input type="button" id="btn_longdesc_shoptouch" value="쇼핑몰 App상세설명" style="width:85px;height:25px;cursor:hand;background-color:#999;color:#fff;" onclick="tabLongdescShow(this);" />
</div>
...
<!-- 관리 메모 -->
<div class=title>관리 메모 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=shoppingapp&no=6')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
