...
function mini_set_font(idx)
{
	...
	var name = new Array("±¼¸²","µ¸¿ò","¹ÙÅÁ","±Ã¼­","±¼¸²Ã¼","Arial","Courier","Tahoma");
...
function miniEditorFrame(obj,idx)
{
	...
	<head>\
		...
		<style>body {margin:10px;} body,table {font:small µ¸¿ò} p {margin:2px 0} td,th {border:1px #bfbfbf dotted}</style>\
