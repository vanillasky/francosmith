...
if($page_type=='mobile') {
	$order_end_page = $cfgMobileShop['mobileShopRootDir'].'/ord/order_return_url.php';
}
else {
	$order_end_page = $cfg['rootDir'].'/order/order_return_url.php';
}
...
// 리턴 URL 설정
$P_NEXT_URL		= $Protocol.$Host.$Port.$cfg['rootDir']."/order/card/inipay/mobile/nscreen_card_return.php?ordno=".$_POST['ordno']."&settlekind=".$_POST['settlekind']."&page_type=".$page_type;
$P_NOTI_URL		= "http://".$Host.$cfg['rootDir']."/order/card/inipay/mobile/vacctinput.php";
$P_RETURN_URL	= $Protocol.$Host.$Port.$order_end_page."?ordno=".$_POST['ordno'];
