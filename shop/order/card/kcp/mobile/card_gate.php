...
<input type="hidden" name='Ret_URL'      value="<?=ProtocolPortDomain()?><?=$cfg['rootDir']?>/order/card/kcp/mobile/card_return.php">
<!-- 인증시 필요한 파라미터(변경불가)-->
...
<form name="pay_form" method="POST" action="<?=$cfg[rootDir]?>/order/card/kcp/mobile/card_return.php">
