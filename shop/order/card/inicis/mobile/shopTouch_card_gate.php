...
<!-- VISA3D 결제 -->
<input type="hidden" name="P_NEXT_URL" value="http://<?=$_SERVER['HTTP_HOST']?><?=$cfg['rootDir']?>/order/card/inicis/mobile/shopTouch_card_return.php">

<!-- ISP 결제 -->
<input type="hidden" name="P_NOTI_URL" value="http://<?=$_SERVER['HTTP_HOST']?><?=$cfg['rootDir']?>/order/card/inicis/mobile/vacctinput.php">
<input type="hidden" name="P_RETURL_URL" value="http://<?=$_SERVER['HTTP_HOST']?><?=$cfgMobileShop['mobileShopRootDir']?>/shopTouch_ord/order_end.php">
