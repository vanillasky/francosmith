...
<html>
<head>
<title>하나은행 매매보호 서비스 반품등록/수정</title>
...
<table>
	...
	<tr>
		...
		<td>	<select name=EscrowType >
			<option value="">선택하십시오
			<option value="rr" selected>반품등록</option>
			<option value="ru">반품수정</option>
			</select>
		</td>
	</tr>
	...
	<tr>
		...
		<option value="">-선택하십시오-</option>
		<option value="0" selected>반품승인</option>
		<option value="1">반품거절</option>
		</select>
	</td>
	</tr>
	<tr>
		...
		<option value="">-선택하십시오-</option>
		<option value="R0">기배송완료</option>
		<option value="R1">기서비스 제공</option>
		<option value="R2">반품물품 미수령</option>
		<option value="R3">반품물품이 원상품과 다름</option>
		<option value="R4">부당구매 철회</option>
		<option value="R5" selected>기타</option>
		</select>
		</td>
	</tr>
	<tr>
