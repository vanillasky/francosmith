...
if($shoppingApp){
    $shoppingApp['app_premium']=unserialize($shoppingApp['app_premium']);
}
...
foreach($shoppingApp['app_premium'] as $data){
	...
	echo "<media:thumbnail width=\"50\" height=\"50\" url=\"".iconv("euc-kr","utf-8",$shopDomain)."/data/m/app/".iconv("euc-kr","utf-8",$data['thumbnail'])."\"/>"."\n";
	echo "</item>"."\n";
