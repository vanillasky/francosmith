...
//			break;
     ...
     */
    $LGD_CASNOTEURL				= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/todayshop/card/lgdacom/cas_noteurl.php";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    $LGD_RETURNURL				= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/todayshop/card/lgdacom/mobile/cart_return.php";
    /*
     *************************************************
...
function setLGDResult(){
	...
	if(document.getElementById('LGD_RESPCODE').value == '0000' ){
		...
		getFormObject().action = "card_return.php";
...
<form method="post" id="LGD_PAYINFO" action="card_return.php">
